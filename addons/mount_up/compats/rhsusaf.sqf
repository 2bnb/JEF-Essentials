if (isClass (configFile >> "CfgPatches" >> "rhsusf_main")) then {
	["RHS_UH60M_base", "init", {
		(_this select 0) setVariable ["bnb_es_proxyOffsets", [
	...
	["RHS_M119_base", "init", {
		(_this select 0) setVariable ["bnb_es_proxyWhitelist", [
			"proxy:gunner.001"
		]];
	}, true, [], true] call CBA_fnc_addClassEventHandler;
	...
	["rhsusf_m998_w_2dr", "init", {
		...
		(_this select 0) setVariable ["bnb_es_proxyBlacklist", [
			"proxy:cargo01.008",
			"2drcargocomplete",
			"2drcargo"
		]];
	...
	["rhsusf_m1151_base", "init", {
		...
		(_this select 0) setVariable ["bnb_es_proxyOverrides", [
			["Turret-1[1]", "proxy:cargo01.001"],
			["cargo0[]", "proxy:\ca\temp\proxies\skodovka\cargo.003"],
			["cargo1[]", "proxy:\ca\temp\proxies\skodovka\cargo.002"]
		]];
	}, true, [], true] call CBA_fnc_addClassEventHandler;

	["RHS_CH_47F_base", "init", {
		(_this select 0) setVariable ["bnb_es_cargoProxyIndexes", [
