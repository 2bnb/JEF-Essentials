/* ----------------------------------------------------------------------------
Function: bnb_es_core_fnc_getDeployAnimations
...
Examples:
	[_vehicle] call bnb_es_core_fnc_getDeployAnimations;
...
[format["Received data: %1, %2, %3", _vehicle, _vehicleClass, _vehicleConfig], "core\functions\common\fn_getDeployAnimations.sqf"] call bnb_es_core_fnc_log;
...
// };
// [format["Checking Config: %1", _animationClasses], "core\functions\common\fn_getDeployAnimations.sqf"] call bnb_es_core_fnc_log;
