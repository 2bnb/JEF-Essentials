...
[
	...
	[
		["Logic", "BNB_ES_Barracks_Module", _spawnPos vectorAdd [-4, 7]],
...
[
	[
		[configfile >> "CfgGroups" >> "West" >> "bnb_es_compositions" >> "infantry" >> _nameCommand, _spawnPos vectorAdd [0, 0]],
		"Command",
		["description", format ["1: 1IC@%1 1-Actual", _callsign ]]
	],
	[
		[configfile >> "CfgGroups" >> "West" >> "bnb_es_compositions" >> "infantry" >> _nameZeus, _spawnPos vectorAdd [1, 2]],
		"Zeus",
...
for "_i" from 1 to _numberOfSections do {
	create3DENComposition [configfile >> "CfgGroups" >> "West" >> "bnb_es_compositions" >> "infantry" >> _nameSection, _spawnPos vectorAdd [_num, 0, 0]];
...
if (_createDefaults) then {
	create3DENComposition [configfile >> "CfgGroups" >> "West" >> "bnb_es_compositions" >> "infantry" >> _nameDefaults, _spawnPos vectorAdd [_num + 2, 3, 0]];
