/* ----------------------------------------------------------------------------
Function: bnb_es_core_fnc_getDeadPlayers
...
Examples:
	[] call bnb_es_core_fnc_getDeadPlayers;
...
[format["Got dead players %1", _deadPlayers], "core\functions\common\fn_getDeadPlayers.sqf"] call bnb_es_core_fnc_log;
_deadPlayers;
