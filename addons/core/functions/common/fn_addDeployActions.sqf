/* ----------------------------------------------------------------------------
Function: bnb_es_core_fnc_addDeployActions
...
Examples:
	[] call bnb_es_core_fnc_addDeployActions;
...
private _animations = [_vehicle] call bnb_es_core_fnc_getDeployAnimations;
			...
			"\A3\ui_f\data\GUI\RscCommon\RscCheckBox\CheckBox_unchecked_ca.paa",
			{
				[
					...
					_this,
					{
						...
						// _vehicle setVariable ["bnb_es_%1_isActive", true];
						[format["Animation data: %1 --- Variables: %2", _this, _animationClass], "core\functions\common\fn_addDeployActions.sqf"] call bnb_es_core_fnc_log;
