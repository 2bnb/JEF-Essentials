/* ----------------------------------------------------------------------------
Function: bnb_es_core_fnc_notifyZeus
...
Examples:
	["Player has respawned", "warning"] call bnb_es_core_fnc_notifyZeus;
	[["Player has died", "and another may afterwards"], "warning"] call bnb_es_core_fnc_notifyZeus;
...
if (!(player call bnb_es_core_fnc_isCurator)) exitWith {};
